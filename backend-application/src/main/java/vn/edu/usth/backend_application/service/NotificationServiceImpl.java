...
public class NotificationServiceImpl implements NotificationService{
    ...
    public NotificationDto createNotification(NotificationDto notificationDto) {
        ...
        User sender = userRepository.findById(notificationDto.getSender_id())
                .orElseThrow(() -> new ResourceNotFoundException("Sender Not Found with id: " + notificationDto.getSender_id()));

        User receiver = userRepository.findById(notificationDto.getSender_id())
                .orElseThrow(() -> new ResourceNotFoundException("Sender Not Found with id: " + notificationDto.getSender_id()));

        Schedule_Event event = scheduleEventRepository.findById(notificationDto.getEvent_id())
                .orElseThrow(() -> new ResourceNotFoundException("Event Not Found with id: " + notificationDto.getEvent_id()));
